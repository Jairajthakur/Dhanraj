    ...
    >
      <View style={styles.card}>
        ...
        <View style={styles.photoSection}>
          ...
          {/* ✅ FIXED: outer shell for shadow (overflow:visible), inner clip for circle */}
          <View style={styles.photoShell}>
            ...
            {/* Camera badge sits outside the clipping wrapper */}
...
const styles = StyleSheet.create({
  ...
  /* ✅ Shell: handles shadow (overflow:visible), sits at bottom of strip */
  photoShell: {
    position: "absolute",
    bottom: -(PHOTO_SIZE / 2),          // half hangs below the strip
    width:  PHOTO_SIZE + 8,             // +8 for the 4px border each side
    height: PHOTO_SIZE + 8,
  ...
  /* ✅ Wrapper: overflow:hidden clips photo to perfect circle */
  photoWrapper: {
    width:  PHOTO_SIZE + 8,
    height: PHOTO_SIZE + 8,
    borderRadius: (PHOTO_SIZE + 8) / 2,
    borderWidth: 4,
    borderColor: "#fff",
    overflow: "hidden",                 // ✅ clips to circle on Android too
    backgroundColor: "#f0f0f0",
  },

  /* ✅ Inner image/placeholder fills the wrapper */
  photoInner: {
    width:  "100%",
    height: "100%",
    alignItems: "center",
  ...
  /* Body */
  cardBody: {
    paddingTop: PHOTO_SIZE / 2 + 16,   // space for overhanging photo
